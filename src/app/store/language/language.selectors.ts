...
export const selectCurrentLanguageDetails = createSelector(selectLanguageState, (state: LanguageState) =>
    state.availableLanguages.find(lang => lang.code === state.currentLanguage)
);

export const selectLanguageLoading = createSelector(selectLanguageState, (state: LanguageState) => state.loading);
